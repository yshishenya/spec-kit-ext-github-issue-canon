...
- Повторный ensure сохраняет существующий PR-шаблон проекта и его обязательные
  проверки. Новый проект получает общий шаблон без закреплённых названий checks.
  Обновление управляемого issue canon, остальных файлов и labels сохранено.
- В выпуск включена поддержка длинных числовых Feature ID из PR #11.
